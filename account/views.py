...
from .serializers import AuthSerializer, UserProfileSerializer, ProfileSerializer, UserAllSerializer
...
class RegisterView(APIView):
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            profile_serializer = ProfileSerializer(data={**request.data, "user": serializer.data["id"]})
            if profile_serializer.is_valid():
                profile_serializer.save()
                return MyResponse.success(data={**serializer.data, **profile_serializer}, message="User registered successfully")
